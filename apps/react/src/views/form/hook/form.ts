...
export const defaultFormColumns: FormColumn[] = [
  { label: '标题', name: 'title', type: 'input', options: [], key: uuid() },
];
...
export const useFormHook = () => {
  ...
  // 全局配置属性
  const [formAttribute, setFormAttribute] =
    useState<FormAttribute>(defaultFormAttribute);
  return {
    form,
    columns,
    setColumns,

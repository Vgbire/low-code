...
import { renderTypeList } from '../utils/const';
...
export const TableColumnControl = (props: TableColumnControlProps) => {
  const {
    currentColumn,
    setCurrentColumn,
    tableColumns,
              ...
              >
                {subFields.map((subField) => (
                  <div key={subField.key}>
                    <Form.Item
                      noStyle
                      name={[subField.name, currentColumn.dataIndex as string]}
                    >
      ...
      <Row gutter={20}>
        <Col flex={1}>
          <Button
            ...
            onClick={() => {
              const index = tableColumns.findIndex(
                (column) => column.dataIndex === currentColumn.dataIndex
              );

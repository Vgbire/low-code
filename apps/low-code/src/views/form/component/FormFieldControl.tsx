...
import { Ellipsis, Selection } from '@libs/ui';
import { Button, Checkbox, Form, Input, Select, Space } from 'antd';
import { FormTypeList } from '../utils/const';
...
export const FormFieldControl = (props: FormFieldControlProps) => {
  const { currentFormIndex, columns, setColumns } = props;
            ...
            <Form.List name="options">
              {(subFields, subOpt) => (
                ...
                >
                  ...
                  <Button
                    type="dashed"
                    onClick={() => subOpt.add({ label: '', value: '' })}
                    block
                  >
                    + 添加
                  </Button>
